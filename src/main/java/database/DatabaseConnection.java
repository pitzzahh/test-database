...
public class DatabaseConnection {
    ...
    public void insertValues(String firstName, String lastName, int age, String address, String studentNumber, Course course) {
        ...
        try {
            ...
            preparedStatement.setObject(6, course); // TODO fix error: Can't infer the SQL type to use for an instance of model.Course. Use setObject() with an explicit Types value to specify the type to use.
